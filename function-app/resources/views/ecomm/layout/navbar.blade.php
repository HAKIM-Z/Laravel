...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <link
            rel="shortcut icon"
            type="image/x-icon"
            href="{{asset('web')}}/assets/images/favicon.svg"
        />

        <link
            rel="stylesheet"
            href="{{asset('web')}}/assets/css/bootstrap.min.css"
        />
        <link
            rel="stylesheet"
            href="{{asset('web')}}/assets/css/LineIcons.3.0.css"
        />
        <link
            rel="stylesheet"
            href="{{asset('web')}}/assets/css/tiny-slider.css"
        />
        <link
            rel="stylesheet"
            href="{{asset('web')}}/assets/css/glightbox.min.css"
        />
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3 col-7">
                            <a class="navbar-brand" href="index-2.html">
                                <img
                                    src="{{asset('web')}}/assets/images/logo/logo.svg"
                                    alt="Logo"
                                />
                            </a>
                        </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="cart-img-head">
                                                        <a
                                                            ...
                                                            ><img
                                                                src="{{asset('web')}}/assets/images/header/cart-items/item1.jpg"
                                                                alt="#"
                                                        /></a>
                                                    </div>
                                                    <div class="content">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="cart-img-head">
                                                        <a
                                                            ...
                                                            href="product-details.html"
                                                            ><img
                                                                src="{{asset('web')}}/assets/images/header/cart-items/item2.jpg"
                                                                alt="#"
                                                        /></a>
                                                    </div>
                                                    <div class="content">
